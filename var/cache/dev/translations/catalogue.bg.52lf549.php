...
$catalogue = new MessageCatalogue('bg', array (
  ...
  array (
    ...
    'This value is already used.' => 'Стойността вече е заета.',
    ...
    'Product name must be at least {{ limit }} characters long.' => 'Името на продукта трябва да бъде поне {{ limit }} символа.',
    'Product name cannot be longer than {{ limit }} characters.' => 'Името на продукта не трябва да бъде повече от {{ limit }} символа.',
    'Product description must be at least {{ limit }} characters long.' => 'Описанието на продукта трябва да е поне {{ limit }} символа',
    'Product description cannot be longer than {{ limit }} characters.' => 'Описанието на продукта не трябва да съдържа повече от {{ limit }} символа',
    'Please, upload the product image.' => 'Моля добавете изображение',
  ...
  array (
    ...
    'security.login.username' => 'Потребител',
    'security.login.password' => 'Парола',
    'security.login.remember_me' => 'Запомни ме',
    'security.login.submit' => 'Вход',
    'security.login.sign_up' => 'Влез в системата',
    'security.register.register' => 'Регистрирай се',
...
',
  ...
  array (
    'Laptops' => 'Лаптопи',
    'Yes' => 'Да',
    'Insert product name' => 'Въведете името на продукта',
    'Insert product description' => 'Въведете описание на продукта',
    'Insert product price' => 'Въведете цената на продукта',
    'Create Product' => 'Създай нов запис ',
    'Reset Product' => 'Изчисти',
    'Insert product price when bought' => 'Въведи цена на продукта при закупуване',
    'Insert product quantity' => 'Въведете количество на продуктите',
    'Product category' => 'Въведи категория на продукта',
    'Product is added by' => 'Продуктът е въведен от',
    'Date added' => 'Дата на добавяне',
    'Your name has already been registered' => 'Съществува продукт със същото име',
    'Laptop accessories' => 'Аксесоари за лаптоп',
    'Laptop bags' => 'Чанти за лаптоп',
    'Laptop cooler' => 'Охалдители за лаптоп',
    'Computer cables' => 'Компютърни лаптопи',
    'Computer peripherals' => 'Компютърна периферия',
    'Mouses and pads' => 'Мишки и подложки',
    'PC speakers' => 'Говорители',
    'PC headphones' => 'Слушалки',
    'Swtich' => 'Суич',
    'Routers' => 'Рутери',
    'Keyboards' => 'Клавиатури',
    'HDD and USB flash drives' => 'HDD and USB flash drives',
    'USB Flash drives' => 'USB Flash drives',
    'External HDD' => 'Външни HDD',
    'Discs' => 'Дискове',
    'Card readers and USB Hubs' => 'Четци за карти и USB Hub',
    'Computers' => 'Компютри',
    'Web cameras' => 'Уеб камери',
