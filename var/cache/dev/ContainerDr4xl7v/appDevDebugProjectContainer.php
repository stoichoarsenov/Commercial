...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array())
    {
        ...
        $this->normalizedIds = array(
            ...
            'appbundle\\controller\\newproductcontroller' => 'AppBundle\\Controller\\NewProductController',
        ...
        $this->fileMap = array(
            ...
            'AppBundle\\Controller\\NewProductController' => __DIR__.'/getNewProductControllerService.php',
        ...
        $this->privates = array(
            ...
            'twig.extension.stfalcon_tinymce' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('fZeEpJFqLj', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('eLGI1GzR3h', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(${($_ = isset($this->services['twig.extension.stfalcon_tinymce']) ? $this->services['twig.extension.stfalcon_tinymce'] : $this->getTwig_Extension_StfalconTinymceService()) && false ?: '_'});
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tBKsLBTZj1', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('g-9doGnjyn', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JjKoX3G0uu', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('409886b7acd612b9607857f88b54b3177806447e')) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['locale_listener'] = new \Symfony\Component\HttpKernel\EventListener\LocaleListener(${($_ = isset($this->services['request_stack']) ? $this->services['request_stack'] : $this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack()) && false ?: '_'}, 'bg', ${($_ = isset($this->services['router']) ? $this->services['router'] : $this->getRouterService()) && false ?: '_'});
    }
    ...
    /**
     * Gets the private 'twig.extension.stfalcon_tinymce' shared service.
     *
    ...
    {
        return $this->services['twig.extension.stfalcon_tinymce'] = new \Stfalcon\Bundle\TinymceBundle\Twig\Extension\StfalconTinymceExtension($this, ${($_ = isset($this->services['assets.packages']) ? $this->services['assets.packages'] : $this->getAssets_PackagesService()) && false ?: '_'});
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_user' => 'symfonytest123@gmail.com',
            'mailer_password' => 'symfonyTest123?',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'symfonytest123@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'symfonyTest123?',
            ...
            'fos_user.model.user.class' => 'AppBundle\\Entity\\FosUserLogin',
